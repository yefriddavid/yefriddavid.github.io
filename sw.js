 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */wo();const Io="my-admin-local",vo=6,b={SALARY_DISTRIBUTION:"salary-distribution",MY_PROJECTS:"my-projects",ASSETS:"assets",ACCOUNTS_MASTER:"accounts-master",METADATA:"metadata",TAXI_VEHICLES:"taxi-vehicles"};function j(){return new Promise((t,e)=>{const n=indexedDB.open(Io,vo);n.onupgradeneeded=r=>{const s=r.target.result;s.objectStoreNames.contains(b.SALARY_DISTRIBUTION)||s.createObjectStore(b.SALARY_DISTRIBUTION),s.objectStoreNames.contains(b.MY_PROJECTS)||s.createObjectStore(b.MY_PROJECTS,{keyPath:"id"}),s.objectStoreNames.contains(b.ASSETS)||s.createObjectStore(b.ASSETS,{keyPath:"id"}),s.objectStoreNames.contains(b.ACCOUNTS_MASTER)||s.createObjectStore(b.ACCOUNTS_MASTER,{keyPath:"id"}),s.objectStoreNames.contains(b.METADATA)||s.createObjectStore(b.METADATA),s.objectStoreNames.contains(b.TAXI_VEHICLES)||s.createObjectStore(b.TAXI_VEHICLES,{keyPath:"id"})},n.onsuccess=r=>t(r.target.result),n.onerror=r=>e(r.target.error)})}const g=b,et=g.ACCOUNTS_MASTER;async function To(){const t=await j();return new Promise((e,n)=>{const s=t.transaction(et,"readonly").objectStore(et).getAll();s.onsuccess=o=>{var i;return e((i=o.target.result)!=null?i:[])},s.onerror=o=>n(o.target.error)})}async function Ao(t){const n=(await j()).transaction(g.TAXI_VEHICLES,"readwrite"),r=n.objectStore(g.TAXI_VEHICLES);r.clear();for(const s of t)r.put(s);await new Promise((s,o)=>{n.oncomplete=s,n.onerror=()=>o(n.error)})}async function Co(){const t=await j();return new Promise((e,n)=>{const s=t.transaction(g.TAXI_VEHICLES,"readonly").objectStore(g.TAXI_VEHICLES).getAll();s.onsuccess=()=>{var o;return e((o=s.result)!=null?o:[])},s.onerror=()=>n(s.error)})}const Do="pico-placa-notify-hours",fe=[8,12,17];async function Ro(){try{const t=await j();return await new Promise(e=>{const r=t.transaction(g.METADATA,"readonly").objectStore(g.METADATA).get(Do);r.onsuccess=()=>e(Array.isArray(r.result)?r.result:fe),r.onerror=()=>e(fe)})}catch(t){return fe}}const ko=["Hoy","Mañana","En 2 días","En 3 días","En 4 días"];async function Oo(){try{const t=new Date,e=t.getHours();if(!(await Ro()).includes(e))return;const r=t.toISOString().split("T")[0],s="pico-placa-".concat(r,"-").concat(e),o=await j();if(await new Promise(p=>{const S=o.transaction(g.METADATA,"readonly").objectStore(g.METADATA).get(s);S.onsuccess=()=>p(!!S.result),S.onerror=()=>p(!1)}))return;let a=await Co();if(a.length||(a=await Mo(),a.length&&await Ao(a)),!a.length)return;const c=[];for(let p=0;p<=4;p++){const w=new Date(t);w.setDate(w.getDate()+p);const S=a.filter(P=>No(P.restrictions,w.getMonth()+1,w.getDate())).map(P=>P.plate);p===0?c.push(S.length?"Hoy: ".concat(S.join(", ")):"Hoy: sin pico y placa"):S.length&&c.push("".concat(ko[p],": ").concat(S.join(", ")))}const l="Pico y Placa",u=c.join(" | ");await(typeof self.registration<"u"?self.registration:await navigator.serviceWorker.ready).showNotification(l,{body:u,icon:"/icons/icon.svg",tag:"pico-y-placa",badge:"/icons/icon.svg"});const f=o.transaction(g.METADATA,"readwrite");f.objectStore(g.METADATA).put(!0,s),await new Promise((p,w)=>{f.oncomplete=p,f.onerror=()=>w(f.error)})}catch(t){console.error("Error in pico-y-placa check:",t)}}function No(t,e,n){if(!t)return!1;const r=t[String(e)];if(!r)return!1;const s=Number(r.d1)||0,o=Number(r.d2)||0;return s!==0&&s===n||o!==0&&o===n}async function Mo(){var t;try{const r="https://firestore.googleapis.com/v1/projects/".concat("cashflow-9cbbc","/databases/(default)/documents/CashFlow_taxi_vehiculos?key=").concat("AIzaSyBCul4mFCoDYWWKwBjNUrkPQSbmq6vXi4g"),s=await fetch(r);return s.ok?((t=(await s.json()).documents)!=null?t:[]).map(Po).filter(i=>i.plate):[]}catch(e){return[]}}function Po(t){var o,i,a,c,l,u,d,f,p,w,S,P,Me,Pe,Le,Be;const e=(o=t.fields)!=null?o:{},n=t.name.split("/").pop(),r=(c=(a=(i=e.restrictions)==null?void 0:i.mapValue)==null?void 0:a.fields)!=null?c:{},s={};for(const[Ft,Ht]of Object.entries(r)){const K=(u=(l=Ht.mapValue)==null?void 0:l.fields)!=null?u:{};s[Ft]={d1:Number((w=(p=(d=K.d1)==null?void 0:d.integerValue)!=null?p:(f=K.d1)==null?void 0:f.doubleValue)!=null?w:0),d2:Number((Pe=(Me=(S=K.d2)==null?void 0:S.integerValue)!=null?Me:(P=K.d2)==null?void 0:P.doubleValue)!=null?Pe:0)}}return{id:n,plate:(Be=(Le=e.plate)==null?void 0:Le.stringValue)!=null?Be:"",restrictions:s}}bn([{"revision":"c6f3e2a98fcef6c3d4c0c1533ea1f3f4","url":"offline.html"},{"revision":"f1ff659538e9cbac8980fd1cb9251c5b","url":"index.html"},{"revision":"5b08b3f17508d9fe42f47af44a6c43a7","url":"favicon.ico"},{"revision":"3394026d133157e5039a62aefd1165a8","url":"404.html"},{"revision":"b4639486fd4ede917de4e099a40605d8","url":"icons/icon.svg"},{"revision":null,"url":"assets/workbox-window.prod.es5-legacy-BMyJTwtC.js"},{"revision":null,"url":"assets/workbox-window.prod.es5-RNCgxoJe.js"},{"revision":null,"url":"assets/vendor-pdfjs-zGQwaeZE.js"},{"revision":null,"url":"assets/vendor-pdfjs-legacy-CYDX97u4.js"},{"revision":null,"url":"assets/vendor-firebase-legacy-DK-Fp9dw.js"},{"revision":null,"url":"assets/vendor-firebase-CSl8kHyK.js"},{"revision":null,"url":"assets/useTranslation-legacy-CXGusuQW.js"},{"revision":null,"url":"assets/useTranslation-RtKhWNrh.js"},{"revision":null,"url":"assets/useLocaleData-legacy-5cfO6hH2.js"},{"revision":null,"url":"assets/useLocaleData-e7YAzqR1.js"},{"revision":null,"url":"assets/useIsMobile-legacy-HhlyGBsm.js"},{"revision":null,"url":"assets/useIsMobile-B8makBk2.js"},{"revision":null,"url":"assets/typeof-legacy-CF8Q5s-V.js"},{"revision":null,"url":"assets/typeof-QjJsDpFa.js"},{"revision":null,"url":"assets/skypatrolCommands-xAJhfgmi.js"},{"revision":null,"url":"assets/skypatrolCommands-legacy-D59IbE8P.js"},{"revision":null,"url":"assets/reselect-legacy-R18s4UXN.js"},{"revision":null,"url":"assets/reselect-D9L2APdZ.js"},{"revision":null,"url":"assets/raspberrypi-Cq0hdVK6.svg"},{"revision":null,"url":"assets/purify.es-legacy-BxZR_a20.js"},{"revision":null,"url":"assets/purify.es-Cq2UBf2m.js"},{"revision":null,"url":"assets/polyfills-legacy-CeUvjBkr.js"},{"revision":null,"url":"assets/perfLogs-legacy-DfLu9P-G.js"},{"revision":null,"url":"assets/perfLogs-CKHDCh2L.js"},{"revision":null,"url":"assets/masters-legacy-DS9NWg-_.js"},{"revision":null,"url":"assets/masters-5iUZCF1w.css"},{"revision":null,"url":"assets/leaflet-legacy-CfRJDOMv.js"},{"revision":null,"url":"assets/leaflet-CKBlaIOB.css"},{"revision":null,"url":"assets/leaflet-Bsl1kYyi.js"},{"revision":null,"url":"assets/jspdf.es.min-legacy-SpxLlvJH.js"},{"revision":null,"url":"assets/jspdf.es.min-DDGGV53O.js"},{"revision":null,"url":"assets/index.esm-legacy-ZYoz58HF.js"},{"revision":null,"url":"assets/index.esm-legacy-DfKmthBL.js"},{"revision":null,"url":"assets/index.esm-legacy-BCopqQ4K.js"},{"revision":null,"url":"assets/index.esm-Dd7H63pM.js"},{"revision":null,"url":"assets/index.esm-D0z9JIb7.js"},{"revision":null,"url":"assets/index.esm-BptKGAod.js"},{"revision":null,"url":"assets/index.es-legacy-N6Px_FuA.js"},{"revision":null,"url":"assets/index.es-BtLxfROw.js"},{"revision":null,"url":"assets/index-z1Jo38eM.js"},{"revision":null,"url":"assets/index-wJXim1EV.js"},{"revision":null,"url":"assets/index-legacy-m7C3Dg7a.js"},{"revision":null,"url":"assets/index-legacy-VF8nUms5.js"},{"revision":null,"url":"assets/index-legacy-DzbFkG4h.js"},{"revision":null,"url":"assets/index-legacy-DgMpSWqz.js"},{"revision":null,"url":"assets/index-legacy-DOrYlIbl.js"},{"revision":null,"url":"assets/index-legacy-DF3WRn-H.js"},{"revision":null,"url":"assets/index-legacy-DC9LIwTn.js"},{"revision":null,"url":"assets/index-legacy-Cs7zKLMV.js"},{"revision":null,"url":"assets/index-legacy-CVEd-brT.js"},{"revision":null,"url":"assets/index-legacy-BZJ31OgZ.js"},{"revision":null,"url":"assets/index-legacy-BQNBLYQX.js"},{"revision":null,"url":"assets/index-legacy-0TY6EDlG.js"},{"revision":null,"url":"assets/index-browser-esm-legacy-DJK9SAKR.js"},{"revision":null,"url":"assets/index-browser-esm-Un4MHIRw.js"},{"revision":null,"url":"assets/index-DqLgiY7B.js"},{"revision":null,"url":"assets/index-DfD7YkIi.js"},{"revision":null,"url":"assets/index-DO6WAViE.js"},{"revision":null,"url":"assets/index-D2fX4hck.js"},{"revision":null,"url":"assets/index-CnOJo_XI.js"},{"revision":null,"url":"assets/index-CkL7zOHO.css"},{"revision":null,"url":"assets/index-Ce3LDYlD.js"},{"revision":null,"url":"assets/index-CJFR_t7O.js"},{"revision":null,"url":"assets/index-CInqjYC6.css"},{"revision":null,"url":"assets/index-C3661INH.js"},{"revision":null,"url":"assets/index-Bqhu8CYJ.css"},{"revision":null,"url":"assets/index-BcpbRG50.css"},{"revision":null,"url":"assets/index-BXSVLfLn.js"},{"revision":null,"url":"assets/index-BILrZHnn.js"},{"revision":null,"url":"assets/index-BANorbzj.css"},{"revision":null,"url":"assets/index-4p0fvZ94.css"},{"revision":null,"url":"assets/index-1b8mhGz1.css"},{"revision":null,"url":"assets/html2canvas.esm-legacy-DIGTxsNk.js"},{"revision":null,"url":"assets/html2canvas.esm-BJcB2cAV.js"},{"revision":null,"url":"assets/formatters-legacy-BtVoW550.js"},{"revision":null,"url":"assets/formatters-DjPFTPa7.js"},{"revision":null,"url":"assets/fileHelpers-legacy-D5NGVuhy.js"},{"revision":null,"url":"assets/fileHelpers-CkniYT0y.js"},{"revision":null,"url":"assets/cryptoHelper-legacy-C7tmD7Ap.js"},{"revision":null,"url":"assets/cryptoHelper-BVphwZtQ.js"},{"revision":null,"url":"assets/cil-x-legacy-Qr_cwwg3.js"},{"revision":null,"url":"assets/cil-x-CfQSVFP2.js"},{"revision":null,"url":"assets/cil-warning-legacy-CzEvJIux.js"},{"revision":null,"url":"assets/cil-warning-CEGefZLr.js"},{"revision":null,"url":"assets/cil-trash-legacy-C42VUvsZ.js"},{"revision":null,"url":"assets/cil-trash-gHK8YSrs.js"},{"revision":null,"url":"assets/cil-plus-legacy-QLKf2chB.js"},{"revision":null,"url":"assets/cil-plus-CjZkVDO0.js"},{"revision":null,"url":"assets/cil-people-legacy-CWYhgM2E.js"},{"revision":null,"url":"assets/cil-people-BzpFUCRV.js"},{"revision":null,"url":"assets/cil-pencil-legacy-CP7gv1FJ.js"},{"revision":null,"url":"assets/cil-pencil-c89ONrkF.js"},{"revision":null,"url":"assets/cil-magnifying-glass-legacy-jKzJX5Hz.js"},{"revision":null,"url":"assets/cil-magnifying-glass-Bjd2ULXB.js"},{"revision":null,"url":"assets/cil-home-legacy-C-mLQb5W.js"},{"revision":null,"url":"assets/cil-home-9yCDO_X0.js"},{"revision":null,"url":"assets/cil-copy-legacy-B25iN0fH.js"},{"revision":null,"url":"assets/cil-copy-BsaR4wcz.js"},{"revision":null,"url":"assets/cil-chevron-right-legacy-BHIg_UAi.js"},{"revision":null,"url":"assets/cil-chevron-right-Bt1LshHI.js"},{"revision":null,"url":"assets/cil-chevron-bottom-legacy-C4rpVcn5.js"},{"revision":null,"url":"assets/cil-chevron-bottom-BNubmxZH.js"},{"revision":null,"url":"assets/cil-calendar-legacy-0x7vYkI6.js"},{"revision":null,"url":"assets/cil-calendar-BVcJRLOY.js"},{"revision":null,"url":"assets/cil-bell-legacy-BpFjnS-u.js"},{"revision":null,"url":"assets/cil-bell-CZe3Rh8Q.js"},{"revision":null,"url":"assets/cil-arrow-top-legacy-ClqzXtem.js"},{"revision":null,"url":"assets/cil-arrow-top-DErzQfBQ.js"},{"revision":null,"url":"assets/cil-arrow-bottom-legacy-DUy9YACi.js"},{"revision":null,"url":"assets/cil-arrow-bottom-DbQMsyby.js"},{"revision":null,"url":"assets/cashFlow-legacy-BiDMk6NP.js"},{"revision":null,"url":"assets/cashFlow-Dmb2--lg.js"},{"revision":null,"url":"assets/auth-legacy-DOlFocEb.js"},{"revision":null,"url":"assets/auth-DzWffXqo.js"},{"revision":null,"url":"assets/auditHelpers-mQnDDK2F.js"},{"revision":null,"url":"assets/auditHelpers-legacy-B9HCQCja.js"},{"revision":null,"url":"assets/appSettings-legacy-KGDs0Z7s.js"},{"revision":null,"url":"assets/appSettings-Bm2Zu0C4.js"},{"revision":null,"url":"assets/admin-oGKHO8XU.js"},{"revision":null,"url":"assets/admin-legacy-DuTDxWOF.js"},{"revision":null,"url":"assets/Visits-legacy-C0Iibvhv.js"},{"revision":null,"url":"assets/Visits-CWf9tKpG.js"},{"revision":null,"url":"assets/Vehicles-legacy-DvGMYFMd.js"},{"revision":null,"url":"assets/Vehicles-BMJ2zwAC.js"},{"revision":null,"url":"assets/Users-legacy-CpFdflYG.js"},{"revision":null,"url":"assets/Users-CV92dxMt.js"},{"revision":null,"url":"assets/Transition-legacy-P2sqw24B.js"},{"revision":null,"url":"assets/Transition-D8kbHrvV.js"},{"revision":null,"url":"assets/Tenants-legacy-DZ379GLj.js"},{"revision":null,"url":"assets/Tenants-Bnc9q_AI.js"},{"revision":null,"url":"assets/TaxisLayout-zO9O1pM4.js"},{"revision":null,"url":"assets/TaxisLayout-legacy-Cgg5pWiJ.js"},{"revision":null,"url":"assets/TaxisLayout-D04kB9Bp.css"},{"revision":null,"url":"assets/SystemLayout-legacy-CBGRaUBX.js"},{"revision":null,"url":"assets/SystemLayout-BIOk5MC_.js"},{"revision":null,"url":"assets/Summary-legacy-BbMLuQ4C.js"},{"revision":null,"url":"assets/Summary-DB8ypL0X.js"},{"revision":null,"url":"assets/StandardForm-legacy-Cg7L47E3.js"},{"revision":null,"url":"assets/StandardForm-RV98SmpK.js"},{"revision":null,"url":"assets/SolarPanel-legacy-gimI_M0r.js"},{"revision":null,"url":"assets/SolarPanel-RD6HNA3L.css"},{"revision":null,"url":"assets/SolarPanel-Ds0RrAUw.js"},{"revision":null,"url":"assets/SerialConsole-legacy-BvXyVvsW.js"},{"revision":null,"url":"assets/SerialConsole-GRoeOcBE.js"},{"revision":null,"url":"assets/SerialConsole-B9YlnqOL.css"},{"revision":null,"url":"assets/SelectApp-legacy-D_4K8SP6.js"},{"revision":null,"url":"assets/SelectApp-CmEMKwL-.css"},{"revision":null,"url":"assets/SelectApp-B-OhRb2K.js"},{"revision":null,"url":"assets/SalaryDistribution-legacy-CYxgTw0Y.js"},{"revision":null,"url":"assets/SalaryDistribution-BMNok2IG.js"},{"revision":null,"url":"assets/Register-legacy-Dy9sPBmS.js"},{"revision":null,"url":"assets/Register-D_SR50Uo.js"},{"revision":null,"url":"assets/PushSubscribers-legacy-ekQOIyMD.js"},{"revision":null,"url":"assets/PushSubscribers-Cp3QCjHy.js"},{"revision":null,"url":"assets/Profile-legacy-CNN0cN_L.js"},{"revision":null,"url":"assets/Profile-D-nousdS.js"},{"revision":null,"url":"assets/PerfLogsPage-legacy-VOQalH0W.js"},{"revision":null,"url":"assets/PerfLogsPage-DaivxLdB.js"},{"revision":null,"url":"assets/Payments-legacy-De3pZrGf.js"},{"revision":null,"url":"assets/Payments-legacy-BYY3VyQO.js"},{"revision":null,"url":"assets/Payments-CmLfzskm.css"},{"revision":null,"url":"assets/Payments-BRlHlEqS.css"},{"revision":null,"url":"assets/Payments-2Col97n8.js"},{"revision":null,"url":"assets/Partners-legacy-rlKkdZIu.js"},{"revision":null,"url":"assets/Partners-BlvuwSdt.js"},{"revision":null,"url":"assets/Page500-legacy-dzAdLPHT.js"},{"revision":null,"url":"assets/Page500-CpZceRDn.js"},{"revision":null,"url":"assets/Page404-legacy-CKVy67dc.js"},{"revision":null,"url":"assets/Page404-Bwe_bN4o.js"},{"revision":null,"url":"assets/Operations-legacy-CKGWHjAa.js"},{"revision":null,"url":"assets/Operations-D0w7zsh9.css"},{"revision":null,"url":"assets/Operations-CvVb3fcn.js"},{"revision":null,"url":"assets/NotificationToaster-legacy-CbYPO-cy.js"},{"revision":null,"url":"assets/NotificationToaster-DxPH3EU7.css"},{"revision":null,"url":"assets/NotificationToaster-CYEM8zeC.js"},{"revision":null,"url":"assets/Login-vEm6Ki-6.js"},{"revision":null,"url":"assets/Login-legacy-PArz45wm.js"},{"revision":null,"url":"assets/Login-legacy-B552X755.js"},{"revision":null,"url":"assets/Login-BeAySpXR.css"},{"revision":null,"url":"assets/ItemDetail-legacy-B0V5KW0j.js"},{"revision":null,"url":"assets/ItemDetail-D61TxUQ7.css"},{"revision":null,"url":"assets/InlinePaymentMethod-legacy-Dh0M1k7x.js"},{"revision":null,"url":"assets/InlinePaymentMethod-ho6DGI_6.js"},{"revision":null,"url":"assets/Index-pNC9Rzx2.css"},{"revision":null,"url":"assets/Index-legacy-BRFMYTlQ.js"},{"revision":null,"url":"assets/Index-legacy-7bOZMnpT.js"},{"revision":null,"url":"assets/Index-EGmuJ3of.css"},{"revision":null,"url":"assets/Index-BY_QbsfW.js"},{"revision":null,"url":"assets/Index-BG4HiHca.js"},{"revision":null,"url":"assets/IncreaseDecrease-legacy-CxdgrhFU.js"},{"revision":null,"url":"assets/IncreaseDecrease-DCYSLV3N.js"},{"revision":null,"url":"assets/Home-legacy-D2ztzI8A.js"},{"revision":null,"url":"assets/Home-legacy-D-b3FP3m.js"},{"revision":null,"url":"assets/Home-DYe5JuOg.css"},{"revision":null,"url":"assets/Home-CQiffSJK.js"},{"revision":null,"url":"assets/Home-B2AOD8YM.js"},{"revision":null,"url":"assets/HardRefresh-legacy-DDJAf4Va.js"},{"revision":null,"url":"assets/HardRefresh-f7d4hPg2.js"},{"revision":null,"url":"assets/Expenses-legacy-DbyT7cdy.js"},{"revision":null,"url":"assets/Expenses-0gKJmr65.js"},{"revision":null,"url":"assets/ErrorLogsPage-legacy-XQjzzvmk.js"},{"revision":null,"url":"assets/ErrorLogsPage-Cj5gpAWj.js"},{"revision":null,"url":"assets/ErrorLogsPage-5ooAB3YN.css"},{"revision":null,"url":"assets/Eggs-legacy-CR2Cdt5r.js"},{"revision":null,"url":"assets/Eggs-G5rcTYag.js"},{"revision":null,"url":"assets/Drivers-legacy-uSbpMT6N.js"},{"revision":null,"url":"assets/Drivers-DVGn_53t.js"},{"revision":null,"url":"assets/DomoticaLayout-legacy-CpF_Z-ev.js"},{"revision":null,"url":"assets/DomoticaLayout-DlvmgOms.js"},{"revision":null,"url":"assets/Distributions-legacy-CYtGg9UT.js"},{"revision":null,"url":"assets/Distributions-BKHiKhiZ.js"},{"revision":null,"url":"assets/Devices-legacy-hSAftRIf.js"},{"revision":null,"url":"assets/Devices-CUJ2WzM6.js"},{"revision":null,"url":"assets/Devices-BnDFC5s2.css"},{"revision":null,"url":"assets/DetailPanel-legacy-CsOt4je1.js"},{"revision":null,"url":"assets/DetailPanel-P5y4J8MU.js"},{"revision":null,"url":"assets/DefaultLayout-legacy-DG_rv2R0.js"},{"revision":null,"url":"assets/DefaultLayout-Bx2wM6tr.js"},{"revision":null,"url":"assets/DefaultLayout-B-xBg0WV.css"},{"revision":null,"url":"assets/Dashboard-legacy-C9wFxrMO.js"},{"revision":null,"url":"assets/Dashboard-CRQ0b2sE.js"},{"revision":null,"url":"assets/Dashboard-CEAaHXHC.css"},{"revision":null,"url":"assets/CommandDictionary-legacy-zZhcm9YT.js"},{"revision":null,"url":"assets/CommandDictionary-CK6zkdmf.js"},{"revision":null,"url":"assets/CommandDictionary--FEOT5Fg.css"},{"revision":null,"url":"assets/Cleanup-legacy-jLm748IP.js"},{"revision":null,"url":"assets/Cleanup-CiK77u9B.css"},{"revision":null,"url":"assets/Cleanup-C0_tvaMs.js"},{"revision":null,"url":"assets/CToastBody-legacy-BXMUGa2q.js"},{"revision":null,"url":"assets/CToastBody-Bnxv1DFd.js"},{"revision":null,"url":"assets/CTabPane-legacy-CrDVUo8x.js"},{"revision":null,"url":"assets/CTabPane-CCGnPiQB.js"},{"revision":null,"url":"assets/CRow-legacy-DQr4tNSW.js"},{"revision":null,"url":"assets/CRow-C9u49-WX.js"},{"revision":null,"url":"assets/CModalTitle-legacy-CA8TMlJm.js"},{"revision":null,"url":"assets/CModalTitle-DSuTtuEU.js"},{"revision":null,"url":"assets/CModalFooter-yRETysSZ.js"},{"revision":null,"url":"assets/CModalFooter-legacy-Czev5GDU.js"},{"revision":null,"url":"assets/CListGroupItem-legacy-DCRsGARr.js"},{"revision":null,"url":"assets/CListGroupItem-D9sPx-r6.js"},{"revision":null,"url":"assets/CInputGroupText-tUg6fSsg.js"},{"revision":null,"url":"assets/CInputGroupText-legacy-CeH5eS4S.js"},{"revision":null,"url":"assets/CFormSelect-legacy-CjaerTAC.js"},{"revision":null,"url":"assets/CFormSelect-BZEaA29P.js"},{"revision":null,"url":"assets/CFormLabel-mPPW7sdc.js"},{"revision":null,"url":"assets/CFormLabel-legacy-Bayt7NV_.js"},{"revision":null,"url":"assets/CFormInput-legacy-C68VDhoU.js"},{"revision":null,"url":"assets/CFormInput-BU3RTv-w.js"},{"revision":null,"url":"assets/CFormControlWrapper-legacy-CeOM1aCT.js"},{"revision":null,"url":"assets/CFormControlWrapper-Bdcg0Iwj.js"},{"revision":null,"url":"assets/CFormControlValidation-sjWqPrYP.js"},{"revision":null,"url":"assets/CFormControlValidation-legacy-Ar17FaJ2.js"},{"revision":null,"url":"assets/CFormCheck-legacy-CBZzov0E.js"},{"revision":null,"url":"assets/CFormCheck-BQ6tGYdf.js"},{"revision":null,"url":"assets/CContainer-legacy-BvgU0Co9.js"},{"revision":null,"url":"assets/CContainer-BxerGRes.js"},{"revision":null,"url":"assets/CCollapse-legacy-BP4CpHj4.js"},{"revision":null,"url":"assets/CCollapse-Cerlvz6j.js"},{"revision":null,"url":"assets/CCloseButton-legacy-y_uixm6s.js"},{"revision":null,"url":"assets/CCloseButton-DtsBAFFg.js"},{"revision":null,"url":"assets/CCardHeader-legacy-D5gw967C.js"},{"revision":null,"url":"assets/CCardHeader-BIkqWkIO.js"},{"revision":null,"url":"assets/CCardBody-legacy-DNkMrXq0.js"},{"revision":null,"url":"assets/CCardBody-DTi1hPOD.js"},{"revision":null,"url":"assets/CCard-legacy-CXuGD17J.js"},{"revision":null,"url":"assets/CCard-BjFD68aA.js"},{"revision":null,"url":"assets/CAlert-legacy--adR2Csd.js"},{"revision":null,"url":"assets/CAlert-DQnYBDe4.js"},{"revision":null,"url":"assets/BrandName-legacy-DqFqrbM6.js"},{"revision":null,"url":"assets/BrandName-DZvmehoa.js"},{"revision":null,"url":"assets/AuditLogsPage-ql4naRXO.js"},{"revision":null,"url":"assets/AuditLogsPage-legacy-CHUV8ecQ.js"},{"revision":null,"url":"assets/AttachmentViewer-qPaL35xT.js"},{"revision":null,"url":"assets/AttachmentViewer-legacy-JxqfHp04.js"},{"revision":null,"url":"assets/AttachmentViewer-BIl1o2Z8.css"},{"revision":null,"url":"assets/Assets-legacy-BOkdqaXr.js"},{"revision":null,"url":"assets/Assets-DNXXcn6n.js"},{"revision":null,"url":"assets/AppSettings-legacy-CgchqT1m.js"},{"revision":null,"url":"assets/AppSettings-B11RldVY.js"},{"revision":null,"url":"assets/AppModal-legacy-QjX5Lh2o.js"},{"revision":null,"url":"assets/AppModal-Di-ce7VC.css"},{"revision":null,"url":"assets/AppModal-Cp8lO7nC.js"},{"revision":null,"url":"assets/AppIcons-legacy-CGHmMHPy.js"},{"revision":null,"url":"assets/AppIcons-8OvSi_gt.js"},{"revision":null,"url":"assets/Accounts-legacy-Bl3DAnfu.js"},{"revision":null,"url":"assets/Accounts-dJbR0um8.js"},{"revision":"5b08b3f17508d9fe42f47af44a6c43a7","url":"favicon.ico"},{"revision":"b4639486fd4ede917de4e099a40605d8","url":"icons/icon.svg"},{"revision":"5799344d081240e4e674912aa225665a","url":"manifest.webmanifest"}]);gn();ot(new wn(new yn({plugins:[{handlerDidError:async()=>caches.match("/offline.html")}]})));self.addEventListener("message",t=>{var e;((e=t.data)==null?void 0:e.type)==="SKIP_WAITING"&&self.skipWaiting()});const Lo=gt({apiKey:"AIzaSyBCul4mFCoDYWWKwBjNUrkPQSbmq6vXi4g",authDomain:"cashflow-9cbbc.firebaseapp.com",projectId:"cashflow-9cbbc",storageBucket:"cashflow-9cbbc.appspot.com",messagingSenderId:"221005846539",appId:"1:221005846539:web:b51908636c88cb25998f0e"}),Bo=So(Lo);Eo(Bo,t=>{var r;const{title:e,body:n}=(r=t.notification)!=null?r:{};self.registration.showNotification(e!=null?e:"Notificación",{body:n,icon:"/icons/icon.svg"})});self.addEventListener("periodicsync",t=>{t.tag==="check-active-accounts"&&t.waitUntil(xo()),t.tag==="pico-y-placa"&&t.waitUntil(Oo())});async function xo(){try{const t=new Date,e=t.getHours();if(![8,12,18].includes(e))return;const r=t.toISOString().split("T")[0],s="last-notify-".concat(r,"-").concat(e),o=await j();if(await new Promise(u=>{const f=o.transaction(g.METADATA,"readonly").objectStore(g.METADATA).get(s);f.onsuccess=()=>u(!!f.result),f.onerror=()=>u(!1)}))return;const c=(await To()).filter(u=>u.active===!0).length;await self.registration.showNotification("Cuentas Activas",{body:"Hay ".concat(c," cuentas activas en este momento."),icon:"/icons/icon.svg",tag:"active-accounts-notification",badge:"/icons/icon.svg"});const l=o.transaction(g.METADATA,"readwrite");l.objectStore(g.METADATA).put(!0,s),await new Promise((u,d)=>{l.oncomplete=()=>u(),l.onerror=()=>d(l.error)})}catch(t){console.error("Error in periodic sync checkActiveAccountsAndNotify:",t)}}
