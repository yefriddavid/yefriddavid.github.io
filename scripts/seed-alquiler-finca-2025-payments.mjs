...
//
// Usage:
//   node scripts/seed-alquiler-finca-2025-payments.mjs           (dry run)
//   node scripts/seed-alquiler-finca-2025-payments.mjs --apply   (write changes)
...
console.log(`\n💸  seed-alquiler-finca-2025-payments`)
...
const app = admin.initializeApp({ credential: admin.credential.cert(SA_PATH) }, 'seed-alquiler-finca-2025')
...
console.log('\n✓ 12 pagos de Alquiler Finca (2025) creados correctamente')
process.exit(0)
