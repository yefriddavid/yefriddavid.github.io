...
// docs, $173.220 each, day 25.
//
// Usage:
//   node scripts/seed-admon-milagrosa-2024-payments.mjs           (dry run)
//   node scripts/seed-admon-milagrosa-2024-payments.mjs --apply   (write changes)
...
console.log(`\n💸  seed-admon-milagrosa-2024-payments`)
...
const app = admin.initializeApp({ credential: admin.credential.cert(SA_PATH) }, 'seed-admon-milagrosa-2024')
...
console.log('\n✓ 12 pagos de Admon (Apt Milagrosa) (2024) creados correctamente')
process.exit(0)
