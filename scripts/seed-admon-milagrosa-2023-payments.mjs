...
// docs, $146.338 each, day 25.
//
// Usage:
//   node scripts/seed-admon-milagrosa-2023-payments.mjs           (dry run)
//   node scripts/seed-admon-milagrosa-2023-payments.mjs --apply   (write changes)
...
console.log(`\n💸  seed-admon-milagrosa-2023-payments`)
...
const app = admin.initializeApp({ credential: admin.credential.cert(SA_PATH) }, 'seed-admon-milagrosa-2023')
...
console.log('\n✓ 12 pagos de Admon (Apt Milagrosa) (2023) creados correctamente')
process.exit(0)
