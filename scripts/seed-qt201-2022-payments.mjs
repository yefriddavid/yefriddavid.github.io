// One-time seed: QT201 (inmobiliaria) has no rent payments recorded for 2022.
// Creates the 12 missing CashFlow_Transactions docs, $500.000 each, day 25.
//
// Usage:
//   node scripts/seed-qt201-2022-payments.mjs           (dry run)
//   node scripts/seed-qt201-2022-payments.mjs --apply   (write changes)
...
const ACCOUNT_MASTER_ID = '16Du30qZN9gBr2abCsfv'
const AMOUNT = 500000
const YEAR = 2022

const apply = process.argv.includes('--apply')

console.log(`\n💰  seed-qt201-2022-payments`)
...
const app = admin.initializeApp({ credential: admin.credential.cert(SA_PATH) }, 'seed-qt201-2022')
...
console.log('\n✓ 12 pagos de QT201 (2022) creados correctamente')
process.exit(0)
