// One-time seed: "Internet Finca" (personal) had a lower rate ($20.000) for
// Jan-Mar 2025 before switching to $70.000 (apr-dec, already seeded).
//
// Usage:
//   node scripts/seed-internet-finca-2025-q1-payments.mjs           (dry run)
//   node scripts/seed-internet-finca-2025-q1-payments.mjs --apply   (write changes)
...
console.log(`\n💸  seed-internet-finca-2025-q1-payments`)
...
const app = admin.initializeApp({ credential: admin.credential.cert(SA_PATH) }, 'seed-internet-finca-2025-q1')
const db = admin.firestore(app)

const pad = (n) => String(n).padStart(2, '0')

const payments = [1, 2, 3].map((month) => ({
  type: 'expense',
  category: 'Servicios',
...
console.log('\n✓ 3 pagos de Internet Finca (2025, ene-mar) creados correctamente')
process.exit(0)
