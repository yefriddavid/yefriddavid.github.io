...
// payments recorded for 2022. Creates the 12 missing CashFlow_Transactions
// docs, day 4, $320.000/month, note "Omar rionegro".
//
// Usage:
//   node scripts/seed-alquiler-finca-2022-payments.mjs           (dry run)
//   node scripts/seed-alquiler-finca-2022-payments.mjs --apply   (write changes)
...
const YEAR = 2022
const AMOUNT = 320000
const NOTE = 'Omar rionegro'

const apply = process.argv.includes('--apply')

console.log(`\n💸  seed-alquiler-finca-2022-payments`)
...
const app = admin.initializeApp({ credential: admin.credential.cert(SA_PATH) }, 'seed-alquiler-finca-2022')
...
console.log('\n✓ 12 pagos de Alquiler Finca (2022) creados correctamente')
process.exit(0)
