...
export const COL_SYSTEM_APP_VERSION = 'System_app_version'
export const COL_SYSTEM_PROGRAMS = 'System_programs'
export const COL_INMOBILIARIA_DESIGNS = 'Inmobiliaria_Designs'
export const COL_INMOBILIARIA_PLANOS = 'Inmobiliaria_Planos'
export const COL_FINANCE_PICTURES = 'Finance_Pictures'
export const COL_FINANCE_SCENES_3D = 'Finance_Scenes3D'
export const COL_FINANCE_PICTURE_VERSIONS = 'versions'
export const COL_FINANCE_SYNC_SESSIONS = 'Finance_sync_sessions'
export const COL_CONTACT_MESSAGES = 'System_contact_messages'
