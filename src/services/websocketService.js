...
export const cryptoPricesWebSocket = new WebSocketService(
  'wss://stream.binance.com:9443/stream?streams=btcusdt@ticker/ethusdt@ticker/solusdt@ticker/linkusdt@ticker/bnbusdt@ticker/paxgusdt@ticker/bchusdt@ticker/avaxusdt@ticker/xrpusdt@ticker/adausdt@ticker/pepeusdt@ticker/atomusdt@ticker',
)
