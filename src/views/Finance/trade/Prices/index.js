...
export default function Prices() {
  ...
  const { changes, loading: histLoading } = useHistoricalChange(SYMBOLS, interval, customDate, prices)
        ...
        <div className="crypto-prices__card" ref={cardRef}>
          ...
          >
            <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <line x1="12.5" y1="12.5" x2="18"  y2="18"  stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
          ...
          <div className={`crypto-prices__change crypto-prices__change--${isPositive ? 'positive' : 'negative'}`}>
            {change == null
              ? <Spinner size="sm" />
              : <>{isPositive ? '▲' : '▼'} {fmtChange(change)} <span style={{ fontWeight: 400, opacity: 0.7 }}>{interval === 'custom' ? customDate : interval}</span></>
            }
          </div>
          ...
          <div className="crypto-prices__stats">
            ...
            <div className="crypto-prices__stat-item">
              ...
              <span className="crypto-prices__stat-value">{fmtVol(data.volume)} {asset?.ticker}</span>
            </div>
            <div className="crypto-prices__stat-item">
        ...
        {ASSETS.map((a) => {
          ...
          return (
            ...
            >
              ...
              {d && (
                <div className={`crypto-prices__mini-change crypto-prices__mini-change--${pos ? 'positive' : 'negative'}`}>
