...
import ByDriverGrid from '../Components/ByDriverGrid'
import ByVehicleGrid from '../Components/ByVehicleGrid'
      ...
      <CCard>
        ...
        <CCardBody style={{ padding: 0 }}>
          {loading ? (
            ...
            <ByDriverGrid byDriver={byDriver} isCurrentPeriod={isCurrentPeriod} fmt={fmt} t={t} />
          ) : viewMode === 'byVehicle' ? (
            <ByVehicleGrid byVehicle={byVehicle} isCurrentPeriod={isCurrentPeriod} fmt={fmt} t={t} />
          ) : viewMode === 'audit' ? (
            <AuditView
