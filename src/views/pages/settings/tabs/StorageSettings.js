...
import { fetchCollectionCounts, SPARK_LIMITS } from 'src/services/providers/firebase/admin/usageMetrics'
...
const StorageSettings = () => {
  ...
  const clearCaches = async () => {
    ...
    try {
      ...
      setSuccess(`${keys.length} caché(s) eliminado(s). La app descargará los archivos de nuevo al recargar.`)
  ...
  return (
    <div>
      ...
      <div className="d-flex align-items-center justify-content-between mb-2">
        ...
        <CButton size="sm" color="secondary" variant="ghost" onClick={loadFirebaseMetrics} disabled={fbLoading}>
          ...
          {MODULE_ORDER.map((mod) => {
            ...
            return (
              <div key={mod} className="mb-3">
                <div className="fw-semibold small text-secondary mb-1 text-uppercase" style={{ letterSpacing: 1 }}>
                  {mod}
                </div>
