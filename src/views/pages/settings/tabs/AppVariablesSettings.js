...
import { getAppSettings, setAppSetting, SETTING_LABELS } from 'src/services/providers/firebase/admin/appSettings'
  ...
  return (
    <div style={{ maxWidth: 640 }}>
      <p style={{ fontSize: 13, color: '#6c757d', marginBottom: 16 }}>
        Variables globales de la aplicación almacenadas en Firebase. Los cambios aplican en tiempo real.
      </p>
          ...
          return (
            ...
            >
              <div>
                ...
                <div style={{ fontSize: 11, color: '#adb5bd', fontFamily: 'monospace', marginTop: 2 }}>
                  {s.key}
                </div>
              </div>
              ...
              <div style={{ display: 'flex', gap: 6 }}>
                {isDirty ? (
                  <>
                    ...
                    >
                      {isSaving ? <CSpinner size="sm" style={{ width: 12, height: 12 }} /> : 'Guardar'}
                    </button>
                    <button
