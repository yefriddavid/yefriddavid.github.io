            ...
            <CRow className="g-3 mb-4">
              <CCol xs={6} sm={4}>
                <div className="border rounded p-3 text-center">
                  ...
                  <div
                    className={`fs-5 fw-bold ${isProfit ? 'text-success' : 'text-danger'}`}
                  >
                    {formatToCOP(diff)}
                  </div>
                </div>
              ...
              <CCol xs={12} sm={8}>
                <div className="border rounded p-3 text-center">
                  ...
                  <div
                    className={`fs-4 fw-bold ${isProfit ? 'text-success' : 'text-danger'}`}
                  >
                    {formatToCOP(earnCOP)}
                  </div>
                </div>
        ...
        <CCard className="shadow-sm">
          ...
          <CCardBody>
            ...
            >
              ...
              <Column dataField="initialValue" caption="Initial Value" format={{ type: 'fixedPoint', precision: 0 }} />
              <Column dataField="finalValue" caption="Final Value" format={{ type: 'fixedPoint', precision: 0 }} />
              <Column
                dataField="diff"
                caption="Diff"
                cellRender={({ value }) => (
              ...
              />
              <Column dataField="inversionValue" caption="Investment" format={{ type: 'fixedPoint', precision: 0 }} />
              <Column
                dataField="profit"
                caption="Profit %"
                cellRender={({ value }) =>
