...
export default function SalaryDistribution() {
  ...
  const distribution = computeDistribution(activeConfig.salary, activeConfig.invert, activeConfig.rows)
      ...
      {!showSummary && (
        <>
          <DistributionTabs
            ...
            onStartRename={(id, name) => { setEditingTabId(id); setEditingTabName(name) }}
          ...
          <DistributionEditor
            ...
            onDrop={(toId) => { reorderRows(dragRowId, toId); setDragRowId(null); setDragOverRowId(null) }}
