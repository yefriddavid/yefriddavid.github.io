  ...
  useEffect(() => {
    ...
    const onMove = (e) => {
      ...
      glow.style.background =
        `radial-gradient(400px circle at ${mx}px ${my}px, rgba(99,102,241,0.12) 0%, transparent 70%)`
    }
  ...
  return (
    <div className="about" ref={containerRef}>
      ...
      <footer className="about__footer">
        Hecho con ♥ · <a href="https://www.linkedin.com/in/yefriddavid" target="_blank" rel="noreferrer">@yefriddavid</a>
      </footer>
