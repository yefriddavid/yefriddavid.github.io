  ...
  >
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0 32px' }}>
      ...
      <div>
        ...
        <DetailRow
          label="Pantalla"
          value={v.screenWidth && v.screenHeight ? `${v.screenWidth} × ${v.screenHeight} px` : null}
        />
        <DetailRow label="Plataforma" value={v.platform} />
        <DetailRow
          label="Cookies"
          value={
            v.cookiesEnabled != null ? (v.cookiesEnabled ? 'Habilitadas' : 'Deshabilitadas') : null
          }
        />
      </div>
    </div>
      ...
      <CCardBody style={{ padding: '16px' }}>
        {loading ? (
          ...
          <StandardGrid keyExpr="id" dataSource={visits} noDataText="Sin registros aún.">
            ...
            />
            <MasterDetail enabled={true} render={({ data }) => <VisitDetail v={data} />} />
          </StandardGrid>
        )}
      </CCardBody>
    </CCard>
