...
import { DataGrid, Editing, Column, Button as GButton, Form } from 'devextreme-react/data-grid'
        ...
        {fetching && !records ? (
          ...
          >
            <Editing allowUpdating={true} allowDeleting={true} mode="form">
              <Form colCount={4}>
                <GroupItem caption="Datos del vehículo" colCount={4} colSpan={4}>
                  <SimpleItem dataField="plate" label={{ text: 'Placa' }} />
                  <SimpleItem dataField="brand" label={{ text: 'Marca' }} />
                  <SimpleItem dataField="model" label={{ text: 'Modelo' }} />
                  <SimpleItem dataField="year" label={{ text: 'Año' }} editorType="dxNumberBox" />
                </GroupItem>
              </Form>
            </Editing>
