  ...
  return (
    <div>
      ...
      <div className="d-flex gap-3 mb-3" style={{ fontSize: 12 }}>
        <span>
          <CBadge color="primary">&nbsp;</CBadge> Predeterminada
        </span>
        <span>
          <CBadge color="success">&nbsp;</CBadge> Personalizada
        </span>
      </div>
      {notifyHours === null ? (
        <CSpinner size="sm" />
        ...
        <>
          ...
          <div className="d-flex align-items-center gap-2">
            ...
            {hoursSaved && !hoursDirty && <span className="text-success small">Guardado</span>}
