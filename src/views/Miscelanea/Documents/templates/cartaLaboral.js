...
export const cartaLaboral = {
  ...
  fields: [
    ...
    { key: 'empleadorNombre', label: 'Nombre del Empleador', placeholder: 'Andrés Enrique Ramírez Mejía' },
    { key: 'empleadorCedula', label: 'Cédula del Empleador', placeholder: '71.377.779' },
    { key: 'empleadoNombre', label: 'Nombre del Empleado', placeholder: 'Yefrin David Ríos Mora' },
    { key: 'empleadoCedula', label: 'Cédula del Empleado', placeholder: '1036622381' },
