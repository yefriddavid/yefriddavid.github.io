...
import * as service from '../../services/providers/firebase/CashFlow/accountStatusNotes'
...
function* createNote({ payload }) {
  try {
    ...
    yield put(actions.successRequestCreate({ id, ...payload, checked: false, createdAt: now, updatedAt: now }))
  } catch (e) {
